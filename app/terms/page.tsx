    ...
    <main className=" grow flex w-full flex-col items-center">
      ...
      >
        ...
        <p className="leading-6 text-sm [&:not(:first-child)]:mt-6  whitespace-pre-line">
          Unless otherwise stated, Pedro Barbeitos and/or its licensors own the
          intellectual property rights for all material on Pedro Barbeitos. All
          ...
          help of the Free Terms and Conditions Generator. Parts of this website
          offer an opportunity for users to post and exchange opinions and
          information in certain areas of the website. Pedro Barbeitos does not
          filter, edit, publish or review Comments prior to their presence on
          the website. Comments do not reflect the views and opinions of Pedro
          Barbeitos,its agents and/or affiliates. Comments reflect the views and
          opinions of the person who post their views and opinions. To the
          extent permitted by applicable laws, Pedro Barbeitos shall not be
          ...
          and/or appearance of the Comments on this website. Pedro Barbeitos
          ...
          these Terms and Conditions. You warrant and represent that: You are
          ...
          activities or unlawful activity. You hereby grant Pedro Barbeitos a

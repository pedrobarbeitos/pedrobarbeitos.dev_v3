    ...
    <main className=" grow flex w-full flex-col items-center">
      <section className="flex grow flex-col items-center max-w-3xl">
        ...
        <p className="leading-7 text-sm [&:not(:first-child)]:mt-6 text-justify">
          ...
          use of Alex Rabin's Website, located at alexrabin.com. By accessing
          this website we assume you accept these terms and conditions. Do not
          continue to use Alex Rabin if you do not agree to take all of the
          ...
          Company&aposs terms and conditions. "The Company", "Ourselves", "We",
        ...
        <p className="leading-7 text-sm [&:not(:first-child)]:mt-6 text-justify">
          ...
          to use cookies in agreement with the Alex Rabin's Privacy Policy. Most
          interactive websites use cookies to let us retrieve the user&aposs

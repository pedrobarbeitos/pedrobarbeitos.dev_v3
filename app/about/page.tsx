    ...
    <main className=" grow flex w-full flex-col items-center">
      <section className="flex grow flex-col items-center max-w-3xl">
        ...
        <p className="leading-7 text-sm [&:not(:first-child)]:mt-6 text-justify">
          ...
          to the Company&aposs terms and conditions. "The Company", "Ourselves",
          ...
          manner for the express purpose of meeting the Client&aposs needs in
          respect of provision of the Company&aposs stated services, in
